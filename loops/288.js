...
void main(){
  ...
  if(mod(offset+1.*(time+10.*vUv.x+vUv.y+offset),1.)<1.-(.75/3.)*f) discard;
...
group.add(mesh);
const geo2 = new THREE.TorusKnotBufferGeometry(1, .66, 200, 36, 1, 3);
const mesh2 = new THREE.Mesh(geo2, mat.clone());
mesh2.material.uniforms.offset.value = 1 / 3;
mesh2.material.uniforms.color.value.setHex(0xc341a5);
group.add(mesh2);
