...
palette.range =   ["#F2BA73", "#A52712", "#BA5217", "#6B4413", "#FCDA8C"];
...
const geometry = new RoundedExtrudedPolygonGeometry(.25, .25, 6);
...
scene.fog = new THREE.FogExp2(palette.range[0], 1.2);
...
function draw(startTime) {
  ...
  for (let j = 0; j < LAYERS; j++) {
    ...
    for (let i = 0; i < POINTS; i++) {
      ...
      const s = Maf.parabola(Maf.mod(t2 / LAYERS + j / LAYERS, 1), 1) * data[i].scale;
