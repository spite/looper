...
void main(){
  float repeat = 1.;
  gl_FragColor = vec4(vDepth *vec3(.001+parabola(mod(repeat*vUv.x+offset+speed*time,1.),50.)/3.)*color,1.);
}
`;
...
const geo = new THREE.TorusKnotBufferGeometry(1, .25, 200, 18, 1, 3);
