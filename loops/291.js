...
void main(){
  if(mod((time+4.*vUv.x+4.*vUv.y),1.)<.95) discard;
...
const geo = new THREE.CylinderBufferGeometry(1, 1, 2, 72, 1, true);
...
function draw(startTime) {
  ...
  mesh2.rotation.y = easings.InOutQuad(t) * Maf.TAU;
  mesh3.rotation.y = easings.InOutCubic(t) * Maf.TAU;
